 ...
 */
package org.opendaylight.sampleapp.cli.commands;
...
public class SampleappCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(SampleappCliTestCommand.class);
    protected final SampleappCliCommands service;

    public SampleappCliTestCommand(final SampleappCliCommands service) {
