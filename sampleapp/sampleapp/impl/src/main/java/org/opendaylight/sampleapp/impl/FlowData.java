...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.sampleapp.rev150105.access.list.access.list.entry.actions.PacketHandling;
...
public class FlowData {
    ...
    public FlowData(AccessListEntry entry) {
        ...
        this.etherType = SampleAppConstants.ETH_TYPE ;
        // TODO change the priority accordingly
        this.priority = SampleAppConstants.FLOW_PRIORITY ;
        this.hardTimeout = SampleAppConstants.DEFAULT_TIMEOUT_VALUE ;
        this.idleTimeout = SampleAppConstants.DEFAULT_TIMEOUT_VALUE ;
        ...
        String [] parts = dstIpAddressTmp
                .split(SampleAppConstants.SUBNET_MASK_SEPARATOR ) ;
