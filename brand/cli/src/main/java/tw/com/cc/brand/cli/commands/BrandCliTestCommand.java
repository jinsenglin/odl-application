 ...
 */
package tw.com.cc.brand.cli.commands;
...
public class BrandCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(BrandCliTestCommand.class);
    protected final BrandCliCommands service;

    public BrandCliTestCommand(final BrandCliCommands service) {
